...
int main() {
    ...
    while (numsteps > stepCounter) {
        ...
        //dt = update_dt2(bodies, timestep, min_dt, E, Emax); // Use this when using energy accuracy (when energy error for a specific time step is to big, divide the time step by 2)
